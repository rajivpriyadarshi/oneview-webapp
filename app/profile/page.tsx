...
export default function ProfilePage() {
  ...
  const [emailPreference, setEmailPreference] = useState("weekly");
  ...
  const avatarColor = getColorFromName(profile.name);
    ...
    <ProtectedRoute>
      ...
      <div className="profile-container">
        <div className="profile-header">
          ...
          <button className="profile-edit-btn" onClick={() => router.push("/profile/edit")}>
            <EditIcon />
            Edit profile
          </button>
        </div>

        <h2 className="profile-section-label">Your account</h2>    
